...
def main(argv: list[str] | None = None) -> int:
    ...
    if not args:
        ...
        # No arguments and a real terminal means a double-clicked .exe: that console is
        # destroyed the moment the process exits, so open a prompt instead of printing
        # help into a window nobody can read. Piped or redirected runs still get help.
